...
var optChecker = function (opt) {
  ...
  if (opt.news !== undefined) {
    opt.news.forEach((subhead, subheadIdx) => {
      it('should have a subhead:' + subheadIdx + ' with valid content_subhead', function () {
        assert.notEqual(subhead.content_subhead, undefined)
      })
      it('should have a subhead:' + subheadIdx + ' with valid contents', function () {
...
describe('opt functions', function () {
  describe('index', function () {
    optChecker(utils.opt_index())
  })
  describe('about', function () {
    optChecker(utils.opt_about())
  })
  describe('donate', function () {
    optChecker(utils.opt_donate())
  })
})
